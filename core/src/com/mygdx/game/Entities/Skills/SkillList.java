...
public abstract class SkillList {
	...
	static {
		...
		NEUTRAL_SKILLS.add(new Skill("Take Down", Elements.NONE, 30, Boolean.FALSE, 7));
		NEUTRAL_SKILLS.add(new Skill("Body Slam", Elements.NONE, 40, Boolean.FALSE, 9));
		...
		FIRE_SKILLS.add(new Skill("Fire Ball", Elements.FIRE, 25, Boolean.FALSE, 6));
		FIRE_SKILLS.add(new Skill("Inferno", Elements.FIRE, 35, Boolean.FALSE, 8));
		FIRE_SKILLS.add(new Skill("Flamethrower", Elements.FIRE, 55, Boolean.FALSE, 10));
		
		//Water Skills
		WATER_SKILLS.add(new Skill("Water gun", Elements.WATER, 20, Boolean.FALSE, 2));
		WATER_SKILLS.add(new Skill("Hydro Pump", Elements.WATER, 30, Boolean.FALSE, 4));
		WATER_SKILLS.add(new Skill("Surf", Elements.WATER, 35, Boolean.FALSE, 6));
		WATER_SKILLS.add(new Skill("Hydro Cannon", Elements.WATER, 45, Boolean.FALSE, 8));
		...
		GRASS_SKILLS.add(new Skill("Razor Leaf", Elements.GRASS, 35, Boolean.FALSE, 6));
		GRASS_SKILLS.add(new Skill("Leaf Blade", Elements.GRASS, 40, Boolean.FALSE, 8));
		GRASS_SKILLS.add(new Skill("Vine Whip", Elements.GRASS, 60, Boolean.FALSE, 10));
	}
}
