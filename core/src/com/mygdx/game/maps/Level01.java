...
public class Level01 extends GameMap{;
	...
	protected void initMap() {
		Enemy e1 = new Enemy("darkknight.png", "darkknightdetail.png", "Dark Knight", 6, 6, 4, 50, 100, Elements.NONE, 2);
		Enemy e2 = new Enemy("slime.png", "slimedetail.png", "Slime", 7, 7, 5, 100, 100, Elements.WATER, 2);
		Enemy e3 = new Enemy("ent.png", "entdetail.png", "Ent", 7, 7, 5, 100, 100, Elements.GRASS, 2);
		Enemy e4 = new Enemy("dragon.png", "dragondetail.png", "Dragon Pup", 7, 7, 5, 100, 100, Elements.FIRE, 2);
		Enemy e5 = new Enemy("dragon.png", "dragondetail.png", "Dragon Pup", 7, 7, 5, 100, 100, Elements.FIRE, 2);
